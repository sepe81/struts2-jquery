...
jQuery(document).ready(function () {
	...
	<#if attributes.customConfig! != "">
	options_${escapedOptionId}.customConfig = "${attributes.customConfig}";
	</#if>
	<#if attributes.skin! != "">
	options_${escapedOptionId}.skin = "${attributes.skin}";
	<#else>
    options_${escapedOptionId}.skin = "moono";
	</#if>
	<#if attributes.toolbar! != "">
	options_${escapedOptionId}.toolbar = "${attributes.toolbar}";
	</#if>
	<#if attributes.width??>
	...
	<#if attributes.uploads!false>
		<#if attributes.uploadHref! != "">
	options_${escapedOptionId}.filebrowserUploadUrl = "${attributes.uploadHref}";
		<#else>
